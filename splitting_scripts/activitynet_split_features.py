...
class_split_path="/home/lriesch29/ExplainableAudioVisualLowShotLearning/dat/ActivityNet/class-split/"

# Path to the text embeddings
path_to_text_embedding="/home/lriesch29/ExplainableAudioVisualLowShotLearning/dat/ActivityNet/features/main_features/text/"

#Path to where to save the features in the required folder structure
output_path_features="/home/lriesch29/ExplainableAudioVisualLowShotLearning/dat/ActivityNet/features/"

# Path to where the SeLaVi features are saved
features_self_sup_path = Path("/home/lriesch29/selavi_distributed_orig/outputs/pretrained_VGGSound/ActivityNet/out512_avg/activity_all_classes512_numsecaud1_avg_cleaned.pkl")

# Path to where the C3D/VGGish features are saved
features_sup_path = Path("/home/lriesch29/ExplainableAudioVisualLowShotLearning/supervised_feature_extraction/out/ActivityNet/activity_averaged_all.pkl")
